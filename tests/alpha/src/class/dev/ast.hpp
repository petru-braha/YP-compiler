...
constexpr char TYC_STAT_TYPE = 106;
constexpr char DEF_STAT_TYPE = 107;
constexpr char ACT_STAT_TYPE = 108;
constexpr char RET_STAT_TYPE = 109;

constexpr char SCP_STAT_TYPE = 110;
constexpr char SCC_STAT_TYPE = 111;

constexpr char IFE_STAT_TYPE = 112;
constexpr char WHL_STAT_TYPE = 113;
constexpr char FOR_STAT_TYPE = 114;
