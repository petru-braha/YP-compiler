...
static const yytype_int16 yyrline[] =
{
     ...
     102,   115,   115,   138,   193,   216,   234,   216,   238,   258,
     238,   262,   262,   263,   263,   264,   264,   266,   267,   268,
     273,   282,   285,   320,   333,   351,   354,   359,   362,   362,
     374,   374,   394,   395,   396,   396,   401,   406,   406,   414,
     423,   423,   428,   433,   433,   441,   453,   454,   455,   455,
     456,   457,   462,   478,   481,   518,   518,   531,   532,   533,
     535,   542,   543,   544,   545,   546,   550,   551,   552,   553,
     554,   554,   555,   565,   566,   567,   571,   572,   573,   574,
     575,   579,   580,   581,   583,   587,   587,   590,   591,   592,
     596
};
#endif
...
#line 238 "YP_parser.ypp"
            ...
            error_flag |= is_error = type_exists((yyvsp[-1].token_name));
            if(is_error)
...
#line 1523 "YP_parser.tab.cpp"
    break;

  case 19: /* $@7: %empty  */
#line 258 "YP_parser.ypp"
                                                   {
              free((yyvsp[-5].token_name)); free((yyvsp[-4].token_name)); 
          }
#line 1531 "YP_parser.tab.cpp"
    break;

  case 21: /* $@8: %empty  */
#line 262 "YP_parser.ypp"
                   { /*type_table[cls_last_name].object_insert(last_object.c_str());*/ }
#line 1537 "YP_parser.tab.cpp"
    break;

  case 23: /* $@9: %empty  */
#line 263 "YP_parser.ypp"
                   { /*type_table[cls_last_name].object_insert(last_object.c_str());*/ }
#line 1543 "YP_parser.tab.cpp"
    break;

  case 25: /* $@10: %empty  */
#line 264 "YP_parser.ypp"
                   { /*type_table[cls_last_name].object_insert(last_object.c_str());*/ }
#line 1549 "YP_parser.tab.cpp"
    break;

  case 30: /* var_decl: R_TYP S_NME ';'  */
#line 273 "YP_parser.ypp"
                          {
...
#line 1619 "YP_parser.tab.cpp"
    break;

  case 34: /* var_call: S_NME  */
#line 333 "YP_parser.ypp"
                {
...
#line 1639 "YP_parser.tab.cpp"
    break;

  case 35: /* fct_decl: R_TYP S_NME fct_synp ';'  */
#line 351 "YP_parser.ypp"
                                   {
            free((yyvsp[-3].token_name)); free((yyvsp[-2].token_name));
          }
#line 1647 "YP_parser.tab.cpp"
    break;

  case 36: /* fct_decl: S_NME S_NME fct_synp ';'  */
#line 354 "YP_parser.ypp"
                                   {
            if(false == type_exists((yyvsp[-3].token_name)))
              yyerror("undefined type");
            free((yyvsp[-3].token_name)); free((yyvsp[-2].token_name));
          }
#line 1657 "YP_parser.tab.cpp"
    break;

  case 38: /* $@11: %empty  */
#line 362 "YP_parser.ypp"
                      {
            if(false == is_already_defined((yyvsp[0].token_name)))
            {
              ...
              function_data f_data((yyvsp[-1].token_name));
              f_data_global = &f_data;
              symbols[LAST_SCOPE].functions_insert((yyvsp[0].token_name), f_data);
            }}
#line 1670 "YP_parser.tab.cpp"
    break;

  case 39: /* fct_defn: R_TYP S_NME $@11 fct_synp scope_begin statement_list  */
#line 369 "YP_parser.ypp"
                                                   {
            f_data_global = nullptr;
            fct_last_name.clear();
            free((yyvsp[-5].token_name)); free((yyvsp[-4].token_name));
          }
#line 1680 "YP_parser.tab.cpp"
    break;

  case 40: /* $@12: %empty  */
#line 374 "YP_parser.ypp"
                      {
            bool error_flag = type_exists((yyvsp[-1].token_name));
            if(error_flag)
              yyerror("undefined type");
            error_flag |= is_already_defined((yyvsp[0].token_name));
...
#line 396 "YP_parser.ypp"
                      {
            f_data_global->
              parameter_insert((yyvsp[0].token_name), &variable_data((yyvsp[-1].token_name)));
            }
#line 1717 "YP_parser.tab.cpp"
    break;
...
#line 1724 "YP_parser.tab.cpp"
    break;

  case 46: /* arr_parm: R_TYP S_NME  */
#line 401 "YP_parser.ypp"
                      {
            f_data_global->
              parameter_insert((yyvsp[0].token_name), &variable_data((yyvsp[-1].token_name)));
            free((yyvsp[-1].token_name)); free((yyvsp[0].token_name));
          }
#line 1734 "YP_parser.tab.cpp"
    break;

  case 47: /* $@14: %empty  */
#line 406 "YP_parser.ypp"
                      {
            if(false == type_exists((yyvsp[-1].token_name)))
              yyerror("undefined type");
            else
              f_data_global->
                parameter_insert((yyvsp[0].token_name), &object_data((yyvsp[-1].token_name)));
            }
#line 1746 "YP_parser.tab.cpp"
    break;

  case 48: /* arr_parm: S_NME S_NME $@14 ',' arr_parm  */
#line 412 "YP_parser.ypp"
                          { free((yyvsp[-4].token_name)); free((yyvsp[-3].token_name));
          }
...
#line 1766 "YP_parser.tab.cpp"
    break;

  case 50: /* $@15: %empty  */
#line 423 "YP_parser.ypp"
                {
            f_data_global->
              parameter_insert(&variable_data((yyvsp[0].token_name)));
            }
#line 1775 "YP_parser.tab.cpp"
    break;

  case 51: /* arr_parm: R_TYP $@15 ',' arr_parm  */
#line 426 "YP_parser.ypp"
                           { free((yyvsp[-3].token_name));
          }
#line 1782 "YP_parser.tab.cpp"
    break;

  case 52: /* arr_parm: R_TYP  */
#line 428 "YP_parser.ypp"
                {
            f_data_global->
              parameter_insert(&variable_data((yyvsp[0].token_name)));
            free((yyvsp[0].token_name));
          }
#line 1792 "YP_parser.tab.cpp"
    break;

  case 53: /* $@16: %empty  */
#line 433 "YP_parser.ypp"
                {
            if(false == type_exists((yyvsp[0].token_name)))
              yyerror("undefined type");
            else
              f_data_global->
                parameter_insert(&object_data((yyvsp[0].token_name)));
            }
#line 1804 "YP_parser.tab.cpp"
    break;

  case 54: /* arr_parm: S_NME $@16 ',' arr_parm  */
#line 439 "YP_parser.ypp"
                           { free((yyvsp[-3].token_name));
          }
#line 1811 "YP_parser.tab.cpp"
    break;

  case 55: /* arr_parm: S_NME  */
#line 441 "YP_parser.ypp"
                 {
            if(false == type_exists((yyvsp[0].token_name)))
              yyerror("undefined type");
            else
...
#line 1857 "YP_parser.tab.cpp"
    break;

  case 64: /* obj_defn: S_NME S_NME OPERATOR_ASSIGN S_NME ';'  */
#line 481 "YP_parser.ypp"
                                                {
            bool error_flag = !type_exists((yyvsp[-4].token_name));
            if(error_flag)
              yyerror("undefined type")
            error_flag |= is_already_defined((yyvsp[-3].token_name));
...
#line 1899 "YP_parser.tab.cpp"
    break;

  case 65: /* $@17: %empty  */
#line 518 "YP_parser.ypp"
